...
describe Bookmark do
  ...
  describe '.update' do
    it 'updates the bookmark with the given data' do
      bookmark = Bookmark.add(title: 'Makers Academy', url: 'http://www.makersacademy.com')
      updated_bookmark = Bookmark.update(id: bookmark.id, title: 'Man City', url: 'http://www.mancity.com')
  
      expect(updated_bookmark).to be_a Bookmark
      expect(updated_bookmark.id).to eq bookmark.id
      expect(updated_bookmark.title).to eq 'Man City'
      expect(updated_bookmark.url).to eq 'http://www.mancity.com'
    end
  end
